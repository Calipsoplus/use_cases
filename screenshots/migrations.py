...
def create_image_default():
    default_data_image = [
        ("crystfel", "schluenz/consolvncs:latest", "tcp://:2375", "", "5901/tcp", "connect via",
         "vnc", 1, "3G", "5G",),
        ("Dawn", "schluenz/consoldawn:002", "tcp://:2375", "", "5901/tcp", "connect via",
         "vnc", 1, "3G", "5G",),
        ("pyMca", "schluenz/consolpymca:002", "tcp://:2375", "", "5901/tcp", "connect via",
         "vnc", 1, "3G", "5G",),
        ("pyFAI", "schluenz/consolpyfai:002", "tcp://:2375", "", "5901/tcp", "connect via",
         "vnc", 1, "3G", "5G",),
...
def create_static_link():
    default_data_image = [
        ("link_google", "https://www.google.com", "", "", "", "","", 1, "3G", "5G",),
        ("HPC_jupyterHub", "https://max-jhub003.desy.de", "", "", "", "","", 1, "3G", "5G",)]
